...
> Пересмотрено: `2026-09-15-step-02-multikey-cache.md` — эндпоинт принимает `q`/`sort`/`dir` и отдаёт `matches`/`order`; приложение вынесено в `createApp` (`app.ts`); у «Команды базы знаний» 0 сотрудников.
